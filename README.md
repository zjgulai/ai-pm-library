...
- 当前仓库内容规模为 864 条：提示词 203、技能 316、钩子 81、MCP 81、智能体 84、开源 99；部署前线上仍以当前发布版本为准。
...
| 分类 | 数量 | 说明 |
|---|---|---|
| 提示词 | 203 | 覆盖创作、产品、开发等 14 个职业角色 |
| 技能 | 316 | 从 Claude Code 到跨境电商的全域技能库 |
| 钩子 | 81 | 事件驱动的自动化工作流 |
| MCP | 81 | 模型上下文协议工具 |
| 智能体 | 84 | AI Agent 框架与编排方案 |
| 开源 | 99 | 精选开源项目 |
| **合计** | **864** | **14 个职业角色** |
