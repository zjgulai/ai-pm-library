...
- 当前仓库内容规模为 924 条：提示词 213、技能 326、钩子 91、MCP 91、智能体 94、开源 109；部署前线上仍以当前发布版本为准。
...
| 分类 | 数量 | 说明 |
|---|---|---|
| 提示词 | 213 | 覆盖创作、产品、开发等 14 个职业角色 |
| 技能 | 326 | 从 Claude Code 到跨境电商的全域技能库 |
| 钩子 | 91 | 事件驱动的自动化工作流 |
| MCP | 91 | 模型上下文协议工具 |
| 智能体 | 94 | AI Agent 框架与编排方案 |
| 开源 | 109 | 精选开源项目 |
| **合计** | **924** | **14 个职业角色** |
