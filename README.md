...
- 当前仓库内容规模为 845 条：提示词 200、技能 313、钩子 79、MCP 79、智能体 80、开源 94；部署前线上仍以当前发布版本为准。
...
| 分类 | 数量 | 说明 |
|---|---|---|
| 提示词 | 200 | 覆盖创作、产品、开发等 14 个职业角色 |
| 技能 | 313 | 从 Claude Code 到跨境电商的全域技能库 |
| 钩子 | 79 | 事件驱动的自动化工作流 |
| MCP | 79 | 模型上下文协议工具 |
| 智能体 | 80 | AI Agent 框架与编排方案 |
| 开源 | 94 | 精选开源项目 |
| **合计** | **845** | **14 个职业角色** |
