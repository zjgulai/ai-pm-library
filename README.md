...
- 当前仓库内容规模为 912 条：提示词 211、技能 324、钩子 89、MCP 89、智能体 92、开源 107；部署前线上仍以当前发布版本为准。
...
| 分类 | 数量 | 说明 |
|---|---|---|
| 提示词 | 211 | 覆盖创作、产品、开发等 14 个职业角色 |
| 技能 | 324 | 从 Claude Code 到跨境电商的全域技能库 |
| 钩子 | 89 | 事件驱动的自动化工作流 |
| MCP | 89 | 模型上下文协议工具 |
| 智能体 | 92 | AI Agent 框架与编排方案 |
| 开源 | 107 | 精选开源项目 |
| **合计** | **912** | **14 个职业角色** |
